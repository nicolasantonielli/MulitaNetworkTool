...
class MenuSuperior:
    ...
    def __init__(self, frame, texto,home):
        ...
        self.botonVolver = ttk.Button(frame, style='barraSuperior.primary.TButton', command=home.tkraise, text='VOLVER', image=self.iconBack)
        self.botonVolver.pack(padx=5, pady=0, side='right')

        self.botonTeclado = ttk.Button(frame, style='barraSuperior.primary.TButton', command=self.tecladoOnbord, text='TECLADO', image=self.iconKeyboard)
